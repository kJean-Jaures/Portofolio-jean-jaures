...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await emailjs.sendForm(
        'service_xegykap', // Replace with your EmailJS service ID
        'YOUR_TEMPLATE_ID', // Replace with your EmailJS template ID
        formRef.current!,
        'n-UeSAPzrS5f8MBaR' // Replace with your EmailJS public key
      );
  ...
  const contactInfo = [
    { icon: Mail, label: 'Email', value: 'kouassijaures@exemple.com', href: 'mailto:kouasssijaures605@exemple.com' },
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Je suis à la recherche d'une <span className="text-emerald-400 font-medium">alternance en cybersécurité</span> et toujours ouvert aux nouvelles opportunités. 
            ...
            <div className="space-y-3">
              {contactInfo.map((item, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-4 p-4 rounded-xl bg-gray-900/50 border border-gray-800/50 hover:border-emerald-500/30 transition-all group"
                >
                  <motion.div
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-medium text-gray-300 group-hover:text-emerald-400 transition-colors">{item.value}</p>
                  </div>
                </motion.a>
              ))}
            </div>
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  />
                  <span className="text-sm text-emerald-400 font-semibold">Disponible pour alternance</span>
                </div>
          ...
          >
            <motion.form
              ...
              className="space-y-5 p-6 md:p-8 rounded-2xl bg-gray-900/50 border border-gray-800/50 relative overflow-hidden"
            >
              {/* Background glow */}
              <motion.div
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-2 mb-6 pb-4 border-b border-gray-800/50">
                  ...
                  <span className="text-sm font-mono text-gray-400">~/contact — send_message.sh</span>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  >
                    <label className="block text-sm font-medium text-gray-400 mb-2 font-mono">
                      <span className="text-emerald-400">$</span> nom
                    </label>
                    <motion.input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700/50 text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all font-mono"
                    />
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  <motion.textarea
                    ...
                    rows={6}
                    required
                    className="w-full px-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700/50 text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all resize-none font-mono"
                  />
                </motion.div>
                {error && (
                  <motion.div
